...
/**
 * DPP management (§ Product Structure) — the teacher/admin side of "what have
 * I shared". Creation itself happens from the Question Bank (filter → select
 * → Create DPP); this is where a teacher sees what exists, fixes who it's
 * shared with, or takes one down.
 */
    ...
    <TeacherShell title="DPP">
      <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-admin-muted">
            Daily Practice Papers you have shared. Create a new one from the{" "}
            <a
      ...
      {loading ? (
        ...
        <p className="rounded-xl border border-dashed border-admin-line bg-white p-10 text-center text-sm text-admin-muted">
          ...
          &ldquo;Create DPP&rdquo; to share your first one.
        </p>
      ) : (
