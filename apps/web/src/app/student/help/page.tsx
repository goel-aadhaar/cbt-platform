...
const CATEGORIES = ["All", "Exams", "Account", "Payments", "Technical"];
...
const FAQS = [
  ...
  },
  {
    ...
    a: "Results are published after the evaluation window closes. If a test you completed isn't visible under Performance Reports within 24 hours, raise a ticket and our team will investigate.",
  },
  {
    q: "How do I reset my password?",
    a: "Passwords are managed by your institute. Contact your institute admin or raise a ticket here and we'll route your request securely.",
  },
  {
            ...
            {FAQS.map((f, i) => {
              ...
              return (
                <div key={f.q} className="py-1">
                  ...
                  >
                    <span className="font-semibold text-admin-ink">{f.q}</span>
                    <ChevronDownIcon
        ...
        <div className="space-y-5">
          ...
          <section className="rounded-2xl border border-admin-line/40 bg-white p-5 shadow-[0_4px_10px_rgba(0,0,0,0.04)]">
            ...
            <p className="mt-3 text-center text-xs text-admin-muted">
              Track ticket status under{" "}
              <Link
                href="/student/updates"
                className="font-semibold text-admin"
              >
                Updates
              </Link>
            </p>
