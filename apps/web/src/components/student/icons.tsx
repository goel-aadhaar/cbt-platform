/**
 * Student portal icons — line glyphs (24px, stroke=currentColor). The portal
 * shares the green "console" palette + Hanken Grotesk with the admin side.
 */
...
export const TrophyIcon = (p: P) => (
  <Base {...p}>
    <path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6M18 9h1.5a2.5 2.5 0 0 0 0-5H18M4 22h16M10 14.66V17c0 .55-.47.98-.97 1.21A4 4 0 0 0 7 21.79M14 14.66V17c0 .55.47.98.97 1.21A4 4 0 0 1 17 21.79M18 2H6v7a6 6 0 0 0 12 0V2Z" />
  </Base>
);
...
export const FlaskIcon = (p: P) => (
  <Base {...p}>
    <path d="M9 3h6M10 3v6.5L4.5 19a1 1 0 0 0 .9 1.5h13.2a1 1 0 0 0 .9-1.5L14 9.5V3" />
...
export const LeafIcon = (p: P) => (
  <Base {...p}>
    <path d="M11 20A7 7 0 0 1 4 13c0-6 4-9 16-9 0 8-4 12-9 12z" />
    <path d="M8 17c3-3 5-5 8-7" />
  </Base>
);
